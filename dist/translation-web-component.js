...
function p(a, t) {
  const e = (t || document.documentElement.lang || "en").toLowerCase(),
    n = document.createElement("template");
  return (
    (n.innerHTML = a),
    n.content.querySelectorAll("t-lang").forEach((i) => {
...
function _(a) {
  ...
  if (t) {
    for (; a.firstChild; ) t.insertBefore(a.firstChild, a);
    t.removeChild(a);
  }
}
s(_, "unwrap");
function m(a, t = "") {
  return window.translation && window.translation[a]
...
const c = class c extends HTMLElement {
  ...
  constructor() {
    super(),
      ...
      this.shadowRoot.appendChild(g.content.cloneNode(!0)),
      ...
      (this._skipInitialTranslationLoad = !1),
      (this._disableJsonTranslations = !1),
      (this._disableLanguageLabelTranslations = !1),
      (this._ready = !1),
  ...
  async connectedCallback() {
    ...
    t && (this.currentLanguageCode = t),
      this.skipInitialTranslationLoad || (await this._initializeTranslations()),
      (this._ready = !0),
      this._render();
  }
      ...
      switch (t) {
        ...
        case "path-to-translation-definitions":
          this._pathToTranslationDefinitions =
            n ?? "translation-definitions.json";
          break;
  ...
  set currentLanguageCode(t) {
    (this._currentLanguageCode = String(t ?? "en")),
  ...
  set currentLanguageDirection(t) {
    (this._currentLanguageDirection = String(t ?? "ltr")),
      this.setAttribute(
        "current-language-direction",
  ...
  set skipInitialTranslationLoad(t) {
    const e = !!t;
    (this._skipInitialTranslationLoad = e),
      e
        ? this.setAttribute("skip-initial-translation-load", "")
        : this.removeAttribute("skip-initial-translation-load");
  }
  ...
  set disableJsonTranslations(t) {
    const e = !!t;
    (this._disableJsonTranslations = e),
      e
        ? this.setAttribute("disable-json-translations", "")
        : this.removeAttribute("disable-json-translations");
  }
  ...
  set disableLanguageLabelTranslations(t) {
    const e = !!t;
    (this._disableLanguageLabelTranslations = e),
      e
        ? this.setAttribute("disable-language-label-translations", "")
        : this.removeAttribute("disable-language-label-translations");
  }
  get ready() {
    return this._ready;
  }
  ...
  _render() {
    ...
    const t = Array.isArray(this._translationDefinitions)
        ? this._translationDefinitions
        : [],
      e = this._currentLanguageCode;
    (this._select.innerHTML = t
      .map((n) => {
        const o = n.languageCode === e ? "selected" : "",
          i = this._disableLanguageLabelTranslations
            ? String(n.label ?? "")
            : m(n.label, n.label);
  ...
  async setLanguage(t) {
    ...
    if (e) {
      if (
        ((this._currentLanguageCode = t),
        (this._currentLanguageDirection = e.languageDirection),
        this.setAttribute("current-language-code", this._currentLanguageCode),
        this.setAttribute(
          "current-language-direction",
          this._currentLanguageDirection,
        ...
        (document.documentElement.dir = e.languageDirection),
        document.body.dispatchEvent(new CustomEvent("lang-change")),
        this._disableJsonTranslations)
      ) {
        this._render();
        return;
      }
      try {
        const o = await (
          await fetch(`${window.location.origin}/translation.${t}.json`)
        ).json();
        (window.translation = o),
